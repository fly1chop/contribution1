...
if (nexacro._Browser != "Runtime" && !nexacro.Element) {
		...
		_pInputElement._createElementHandle = function (owner_elem, _doc) {
			...
			if (nexacro._enableaccessibility) {
				...
				if (nexacro._accessibilitytype == 4 || nexacro._accessibilitytype == 5) {
					nexacro.__setDOMAccessibility_Role(handle, owner_elem.name);
				}
			}
	...
	_pInputElement._on_sys_compositionend = function (evt) {
		...
		if (input_handle) {
			...
			if (pThis._evtorder_compositionend_is_last) {
				...
				comp = pThis.parent_elem.linkedcontrol;
	...
	_pTextAreaElement._createElementHandle = function (owner_elem, _doc) {
		...
		if (nexacro._enableaccessibility) {
			...
			if (nexacro._accessibilitytype == 4 || nexacro._accessibilitytype == 5) {
				nexacro.__setDOMAccessibility_Role(handle, this.parent_elem.name);
			}
		}
		...
		if (handle !== undefined) {
			if (name) {
				...
				if (property !== undefined) {
					if (property === null || (typeof property !== "undefined" && typeof property != "object" && property != undefined && typeof property != "function")) {
						return property;
					}
