...
if (nexacro._Browser == "Runtime") {
	if (!nexacro._Init_systembase_runtime) {
		...
		_pProgressData._on_fire_onload = function (bufferObj, nLoadType) {
			...
			while (bLoop) {
				...
				switch (this._data_type) {
					case "CSV":
						ds._loadFromCSVArray(bufferObj._colLines[0], lines, 0, -1, bufferObj._useclientlayout, bufferObj._is_first_load);
						break;
					case "SSV":
						ds._loadFromSSVArray(bufferObj._colLines, lines, 0, -1, bufferObj._useclientlayout, bufferObj._is_first_load);
						break;
					case "PPX":
		...
		nexacro._setBrowserErrorMsg = function () {
			var errorcode = ["comm_http_400", "comm_http_404", "comm_http_405", "comm_http_500", "comm_http_503", "comm_http_499", "comm_http_599", "comm_http_401", "comm_http_402", "comm_http_403", "comm_http_406", "comm_http_407", "comm_http_408", "comm_http_301", "comm_http_302", "comm_http_305", "comm_http_307", "native_notexist_licensefile", "native_expire_license", "native_invalid_licensefile", "native_license_invaliddomain", "native_license_fail_parse", "native_license_invalidservice", "msg_access_invalid_file", "msg_access_invalid_domain", "msg_access_invalid_cert", "msg_permit_folder", "msg_permit_domain", "msg_permit_cert", "range_argument"
			];
